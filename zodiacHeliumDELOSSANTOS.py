year = int(input("Enter your birth year: ")) #This asks for to input integer birth year and saves it by the variable year

if year < 1900: #Prints invalid year if input is lesser than 1900
    print("Invalid Year, it should not be earlier than 1900")

# This part prints ur chinese zodiac sign based on the remainder of your birthyear divided by 12
elif year % 12 == 4: 
